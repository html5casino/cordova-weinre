...
var Channel, HttpChannelHandler, channelManager, handleCreate, handleError, handleGet, handleOptions, handlePost, http, setCORSHeaders, setCacheHeaders, utils, _;
...
handleCreate = function(pathPrefix, isClient, request, response) {
  var channel, id, options, remoteAddress, req, _ref, _ref1;
  ...
  req = http.get(options, function(res) {
    return utils.logVerbose('OKAPI AUTH CALL:' + res.statusCode);
  });
  req.on('error', function(err) {
    return utils.logVerbose('OKAPI AUTH CALL ERROR:' + err);
  });
